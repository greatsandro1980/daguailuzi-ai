...
def self_play_train(model, n_games=5000, lr=5e-5):
    """自我博弈训练：模型与自己对战"""
    game = Game()
    ...
    for g in range(n_games):
        ...
        while True:
            ...
            if done:
                ...
                for team_idx in range(2):
                    team_reward = 1.0 if winner == team_idx else 0.0
                    for data in episode_data[team_idx]:
                        data['reward'] = team_reward
                ...
                for team_idx in range(2):
                    for data in episode_data[team_idx]:
                        ...
                        memory['rewards'].append(data['reward'])
        ...
        if (g + 1) % 500 == 0:
            ...
            if combined > best_combined:
                ...
                best_rule = r1
                best_random = r2
                torch.save(model.state_dict(), '/workspace/projects/rl_v14f_best.pt')
                print(f"    ★ 新最佳!")
...
def main():
    ...
    if os.path.exists('/workspace/projects/rl_v14f_best.pt'):
        model.load_state_dict(torch.load('/workspace/projects/rl_v14f_best.pt', weights_only=True))
